...
export function MoonDivider({ className = "" }: MoonDividerProps) {
  return (
    ...
    >
      ...
      {/* Waxing */}
      <div className="h-3 w-3 rounded-full border border-accent/40 bg-gradient-to-r from-accent/50 to-transparent" />
      {/* Full moon */}
      <div className="h-3.5 w-3.5 rounded-full bg-accent/60" />
      {/* Waning */}
      <div className="h-3 w-3 rounded-full border border-accent/40 bg-gradient-to-l from-accent/50 to-transparent" />
      {/* New moon */}
      <div className="h-3 w-3 rounded-full border border-accent/40" />
